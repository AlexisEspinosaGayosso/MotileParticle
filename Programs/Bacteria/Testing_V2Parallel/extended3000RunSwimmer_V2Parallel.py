...
resultsDirHere='/scratch/pawsey0106/espinosa/Python/Results_Extended3000_'+SwimmerTypeHere+'_Re'+str(ReynoldsHere)
...
Dc=1
ExtendedFactorIni=200
YExtendedSeedIni=PassiveEdge[iRey]*ExtendedFactorIni #Starting from the Extended200
#ExtendedFactorLast=3000
#YExtendedSeedLast=PassiveEdge[iRey]*ExtendedFactorLast
YExtendedSeedLast=SwimSpeedHere*XSeedReady[iRey]*1.25 #Estimating the last seeding point with the possible spread due to swimming speed
...
#The content of operations to perform
    cloudNameI=fieldHere.fieldType+'Re'+str(fieldHere.Reynolds)+'_'+particleHere+'_'+SwimmerTypeHere+'_'+str(meanunround)+'_'+str(i)+'Extended3000'

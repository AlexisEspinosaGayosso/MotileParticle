...
resultsDirHere='/scratch/pawsey0106/espinosa/Python/Results_Round2_'+SwimmerTypeHere+'_Re'+str(ReynoldsHere)
...
NPoints=96 #ideally 25 or more for production   
keepGoing=True
...
#The content of operations to perform
    cloudNameI=fieldHere.fieldType+'Re'+str(fieldHere.Reynolds)+'_'+particleHere+'_'+SwimmerTypeHere+'_'+str(meanunround)+'_'+str(i)+'FinalRun'
